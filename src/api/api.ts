...
class RTCCallApi {
    ...
    private loadDomain() {
        ...
        if (iframe && this.hostContainer) {
            ...
            iframe.src = `${domain}?meetingId=${this.options.callId}&name=${this.options.userConfig.displayName}&peerId=${this.options.userConfig.jobId}&title=${this.options.interfaceConfig.title}&subtitle=${this.options.interfaceConfig.subtitle}&mic=${true}&muteCamera=${this.options.interfaceConfig.muteCam}&profilePicuteUrl=${this.options.userConfig.profilePicuteUrl}&color=${this.options.userConfig.color}&backgroundColor=${this.options.interfaceConfig.backgroundColor}&textColor=${this.options.interfaceConfig.textColor}`;
